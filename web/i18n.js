...
const I18N = {
  ru: {
    ...
    menu_cat_download: "DOWNLOAD",
    menu_download: "Скачать релизы",
    download_desc: "Скачивает готовые релизы напрямую из официальных репозиториев в папку \"zapret\" рядом с панелью.",
    download_av_warning: "Антивирус может пометить сам zapret-web-panel.exe или файлы WinDivert/winws — это известный ложноположительный паттерн для неподписанных PyInstaller-сборок и низкоуровневых сетевых драйверов, а не признак заражения. Подробности — в README.",
    download_zapret1_title: "ZAPRET (zapret-discord-youtube)",
    download_zapret2_title: "ZAPRET2 (zapret-win-bundle)",
    field_download_release: "Релиз",
    btn_reload_releases: "Обновить список",
    btn_download: "Скачать",
    btn_download_latest: "Скачать последнюю сборку",
    msg_downloading: "Загрузка...",
    log_download_start: "Скачивание {name}...",
    log_download_done: "Готово: {name}\n{path}",
  ...
  en: {
    ...
    menu_cat_download: "DOWNLOAD",
    menu_download: "Download releases",
    download_desc: "Downloads ready-to-use releases straight from the official repos into a \"zapret\" folder next to the panel.",
    download_av_warning: "Antivirus software may flag zapret-web-panel.exe itself, or the WinDivert/winws files — this is a known false-positive pattern for unsigned PyInstaller builds and low-level network drivers, not a sign of infection. See the README for details.",
    download_zapret1_title: "ZAPRET (zapret-discord-youtube)",
    download_zapret2_title: "ZAPRET2 (zapret-win-bundle)",
    field_download_release: "Release",
    btn_reload_releases: "Reload list",
    btn_download: "Download",
    btn_download_latest: "Download latest build",
    msg_downloading: "Downloading...",
    log_download_start: "Downloading {name}...",
    log_download_done: "Done: {name}\n{path}",
